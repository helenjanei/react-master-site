        ...
        <div className='cards__wrapper'>
          <ul className='cards__items'>
            ...
            <ReactCardFlip isFlipped={this.state.isFlipped}flipSpeedBackToFront={2}
              ...
              <div>
                <button className='btn  btn--primary btn--medium '  onClick={this.handleClick}>Back</button>
              <div className='cards__item cards__item__link'>
                ...
                <p className='explanation_text'>I identified that the low national raw marks achieved by students on the Shakespeare Exam made any extra raw marks from this element raise the overall exam grade by more than those achieved on any other paper. Extra time spent improving student exam answers on this element should therefore pay dividends in the overall GCSE grade. </p>
                <p className='explanation_text'>I achieved student buy-in to the strategy by using my hard data evidence to show why extra time spent by the students on Shakespeare would be worth it. </p> 
                <p className='explanation_text'>I developed in-depth resources and writing guides to improve student attainment. I employed rigorous testing and improvement, using completion and immediate rewards/feedback to gain buy in from disengaged learners. </p>
...
<ReactCardFlip isFlipped={this.state.isFlipped}flipSpeedBackToFront={2}
              ...
              <div>
                ...
                <p className='explanation_text'>I researched various techniques and ultimately decided upon creating a patchwork wallpaper using individual pages from second hand books.</p> <p className='explanation_text'> I sourced a variety of cheap second hand texts which represented my personality and interests.</p> <p className='explanation_text'>I used over 500 pages in all, and applied each page with wallpaper paste and a spirit level to ensure consistency and a professional finish.</p>
...
<ul className='cards__items'>
            ...
            <ReactCardFlip isFlipped={this.state.isFlipped}flipSpeedBackToFront={2}
              ...
              <div>
                ...
                <p className='explanation_text'>When out for a walk locally, I noticed a footpath that seemed to go to nowhere. To my mind, its existence raised a number of questions, why was it there? Who used to use it? Why was it so pointless?</p> <p className='explanation_text'> I began by looking at old maps, and established that in 1840 the footpath was in existence, and connected a small cluster of houses with the local 'big hall' garden gate (since closed in)</p> <p className='explanation_text'> Once I had this clue, I began to research the big hall, (now a private residence not viewable from the road), then the houses the staff must have come from to use the footpath. I discovered a rich local history of early Yorkshire woolen manufacture, the names and lives of those involved and how they walked the 'pointless' footpath to work and to sell their home made goods to the big house.                  
              </p>
